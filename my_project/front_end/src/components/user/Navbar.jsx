...
import { logout } from '../../redux/reducer/user_reducer'
          ...
          <div className='funct'>
            ...
            <div className='profile-menu'>
              ...
              {showMenu && (
                ...
                <Link to="/settings" onClick={() => setShowMenu(false)}>⚙️ Settings</Link>
                <Link to="/history" onClick={() => setShowMenu(false)}>✈️vol History</Link>
